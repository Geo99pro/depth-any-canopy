...
def main(args: DictConfig):
    ...
    if args.dataset.is_test:
        experiment_id = f"test-{dataset_name}-{model_name}-{experiment_id}"
    else:
    ...
    if not args.dataset.is_test:
        ...
        train_dataset, val_dataset = PrepareDataset(**args.dataset, output_path=output_path).get_train_val_loader()
        ...
        test_dataset = PrepareDataset.get_test_loader(source_tiff_path=args.dataset.source_tiff_path,
